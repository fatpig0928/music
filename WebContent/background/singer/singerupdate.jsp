...
<html>
	...
	<table border="1" spacing="2" >
		...
		<tr align="center" bgcolor="#ff6644" >
			<td ><b>ID</b></td>
			<td width="50px"><b>歌手</b></td>
			<td width="50px"><b>地区</b></td>
			<td ><b>修改</b></td>
		</tr>
<%!
...
<%
	...
	try{
		...
		do{
			...
			count++;
			%>
		<form action="singerupdate_check.jsp" method="post" >
		<input type="hidden" name="id" value="<%=id%>">
		<tr bgcolor="white">
			<td><%=id%></td>
			<td><input type="text" name="singer"  value="<%=singer%>"size="30"></td>
			<td><input type="text" name="nation" value="<%=nation%>" size="30"></td>
...
<div id="page">
<a href = "singerupdate.jsp?curPage=1" >首页</a>
<a href = "singerupdate.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "singerupdate.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "singerupdate.jsp?curPage=<%=pageCount%>" >尾页</a>
