...
<div id="page">
<a href = "find.jsp?curPage=1" >首页</a>
<a href = "find.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "find.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "find.jsp?curPage=<%=pageCount%>" >尾页</a>
