...
<html>
	...
	<table border="1" spacing="2">
		...
		<tr align="center" bgcolor="#ff6644" >
			...
			<td width="80px"><b>专辑</b></td>
			<td width="30px"><b>类型</b></td>
			<td width="80px"><b>路径</b></td>
...
<%
	...
	try{
		...
		<tr align="center" bgcolor="white">
					...
					<td><%=path%></td>
					<td>
						<a href="delete_check.jsp?id=<%=id%>">删除</a>
					</td>
				</tr>
			<%
		}while(rs.next());
...
<div id="page">
<a href = "delete.jsp?curPage=1" >首页</a>
<a href = "delete.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "delete.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "delete.jsp?curPage=<%=pageCount%>" >尾页</a>
