...
<%
	...
	try{
		...
		<tr align="center" bgcolor="white">
					...
					<td><%=aritist%></td>
					<td>
						<a href="typedelete_check.jsp?typeid=<%=typeid%>">删除</a>
					</td>
				</tr>
			<%
		}while(rs.next());
...
<div id="page">
<a href = "typedelete.jsp?curPage=1" >首页</a>
<a href = "typedelete.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "typedelete.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "typedelete.jsp?curPage=<%=pageCount%>" >尾页</a>
