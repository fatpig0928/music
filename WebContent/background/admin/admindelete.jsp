...
<%
	...
	try{
		...
		<tr align="center" bgcolor="white">
					...
					<td><%=pwd%></td>
					<td>
						<a href="admindelete_check.jsp?id=<%=id%>">删除</a>
					</td>
				</tr>
			<%
		}while(rs.next());
...
<div id="page">
<a href = "userdelete.jsp?curPage=1" >首页</a>
<a href = "userdelete.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "userdelete.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "userdelete.jsp?curPage=<%=pageCount%>" >尾页</a>
