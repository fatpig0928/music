...
<%
	...
	try{
		...
		do{
			...
			count++;
			%>
		<form action="adminupdate_check.jsp" method="post" >
		<input type="hidden" name="id" value="<%=id%>">
		<tr bgcolor="white">
			<td><%=id%></td>
			<td><input type="text" name="name"  value="<%=name%>"size="30"></td>
			<td><input type="text" name="pwd" value="<%=pwd%>" size="30"></td>
...
<div id="page">
<a href = "adminupdate.jsp?curPage=1" >首页</a>
<a href = "adminupdate.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "adminupdate.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "adminupdate.jsp?curPage=<%=pageCount%>" >尾页</a>
