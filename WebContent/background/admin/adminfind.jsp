...
<div id="page">
<a href = "adminfind.jsp?curPage=1" >首页</a>
<a href = "adminfind.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "adminfind.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "adminfind.jsp?curPage=<%=pageCount%>" >尾页</a>
